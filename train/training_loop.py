...
class TrainLoop:
    ...
    def run_loop(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            if min_loss > each_loss["total"]:
                self.save()
                min_loss = each_loss["total"]

            print('Epoch[{}]: loss[{:0.5f}]'.format(epoch, each_loss["total"]))
    ...
    def forward_backward(self, batch, cond):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            total_losses['total'].append(loss.detach().cpu().numpy())
