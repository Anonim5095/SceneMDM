...
if __name__ == "__main__":
    ...
    input_dir = "./save/humanml_only_text_condition/result_pick_up_coffee_on_desk_and_drink/sample17_rep00_iter=20"
    output_ply_dir  = os.path.join(os.path.dirname(input_dir), os.path.basename(input_dir) + "_converted")


    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    smplx_model_folder = './OS-POSA/POSA_dir/smplx_models'
    num_pca_comps = 6
