...
def convert_smplx2humanml(body_model, device, data_path, save_path, scene_name=None):
    ...
    def amass_to_pose(src_path):
        bdata = pickle.load(open(src_path, 'rb'))
        # bdata = np.load(src_path, allow_pickle=True)

        fps = 20
        fId = 0 # frame id of the mocap sequence
        pose_seq = []
        frame_number = bdata['transl'].shape[0]
        ...
        with torch.no_grad():
            for fId in range(0, frame_number, down_sample):
                ...
                body = body_model(pose_body=pose_body, pose_hand=pose_hand, betas=betas, root_orient=root_orient)
        ...
        return pose_seq_np_n, bdata['t_fm_orig'], bdata['R_fm_orig'], bdata['keyframes'], bdata['length']


    data, trans, orient, keyframes, length = amass_to_pose(data_path)
...
if __name__ == "__main__":
    data_path = './save/debug_Werkraum_default/pkl/Werkraum/rp_ellie_posed_010_0_0_00.pkl'
    save_path = "./save/debug_Werkraum_default/pkl/Werkraum/rp_ellie_posed_010_0_0_00.npy"
    ...
    convert_smplx2humanml(male_bm, device, data_path, save_path)
